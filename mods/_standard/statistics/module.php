...
$this->_pages['mods/_standard/statistics/course_stats.php']['children']     = array('mods/_standard/tracker/tools/student_tool_stats.php','mods/_standard/tracker/tools/index.php','mods/_standard/tracker/tools/student_usage.php');
