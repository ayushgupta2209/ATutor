...
<div class = "contentbox-stats">
	<div class = "contentbox-report">
		<table class="data static" summary="">
			...
			<tr>
				...
				<td><?php echo '<a href='.AT_BASE_HREF.url_rewrite('content.php?cid='.$this->contentkeyVal['maxVisits'][0]). '>'. $contentManager->_menu_info[$this->contentkeyVal['maxVisits'][0]]['title']. '<a>'; ?></td>
				<td><?php echo $this->contentkeyVal['maxVisits'][1]; ?></td>
			</tr>
			<tr>
				<td title = "Content with Maximum Time devoted">	Maximum Time devoted	</td>
				<td><?php echo '<a href='.AT_BASE_HREF.url_rewrite('content.php?cid='.$this->contentkeyVal['maxTime'][0]). '>'. $contentManager->_menu_info[$this->contentkeyVal['maxTime'][0]]['title']. '<a>'; ?></td>
				<td><?php echo $this->contentkeyVal['maxTime'][1]; ?></td>
			</tr>
			<tr>
				<td	title= "Content with Maximum Visitors">	Maximum Visitors	</td>
				<td><?php echo '<a href='.AT_BASE_HREF.url_rewrite('content.php?cid='.$this->contentkeyVal['maxVisitors'][0]). '>'. $contentManager->_menu_info[$this->contentkeyVal['maxVisitors'][0]]['title']. '<a>'; ?></td>
	...
	<div class = "contentbox-report">
			...
			<tr>
				...
				<td><?php echo '<a href='.AT_BASE_HREF.url_rewrite('mods/_standard/blogs/post.php?ot=1&oid='. $this->blogkeyVal['maxVisits'][2].'&id='. $this->blogkeyVal['maxVisits'][3]).'>' .  $this->blogkeyVal['maxVisits'][0]. '</a>'; ?></td>
				<td><?php echo $this->blogkeyVal['maxVisits'][1]; ?></td>
			</tr>
			<tr>
				<td title= "Blog with Maximum Comments">	Maximum Comments	</td>
				<td><?php  echo '<a href='.AT_BASE_HREF.url_rewrite('mods/_standard/blogs/post.php?ot=1&oid='. $this->blogkeyVal['maxComments'][2].'&id='. $this->blogkeyVal['maxComments'][3]).'>' .  $this->blogkeyVal['maxComments'][0]. '</a>'; ?></td>
				<td><?php echo $this->blogkeyVal['maxComments'][1]; ?></td>
			</tr>
			<tr>
				<td	title= "Blog with Maximum Visitors">	Maximum Visitors	</td>
				<td><?php echo '<a href='.AT_BASE_HREF.url_rewrite('mods/_standard/blogs/post.php?ot=1&oid='. $this->blogkeyVal['maxVisitors'][2].'&id='. $this->blogkeyVal['maxVisitors'][3]).'>' .  $this->blogkeyVal['maxVisitors'][0]. '</a>'; ?></td>
	...
	<div class = "contentbox-report">
		<table class="data static" summary="">
			...
			<tr>
				...
				<td><?php echo '<a href='.AT_BASE_HREF.url_rewrite('mods/_standard/forums/forum/index.php?fid='.$this->forumkeyVal['maxVisits'][2]). '>' . $this->forumkeyVal['maxVisits'][0]. '</a>' ?></td>
				<td><?php echo $this->forumkeyVal['maxVisits'][1]; ?></td>
			</tr>
			<tr>
				<td title = "Forum with Maximum Posts">	Maximum Posts	</td>
				<td><?php echo '<a href='.AT_BASE_HREF.url_rewrite('mods/_standard/forums/forum/index.php?fid='.$this->forumkeyVal['maxPosts'][2]). '>' . $this->forumkeyVal['maxPosts'][0]. '</a>' ?></td>
				<td><?php echo $this->forumkeyVal['maxPosts'][1]; ?></td>
			</tr>
			<tr>
				<td	title= "Forum with Maximum Visitors">	Maximum Visitors	</td>
				<td><?php echo '<a href='.AT_BASE_HREF.url_rewrite('mods/_standard/forums/forum/index.php?fid='.$this->forumkeyVal['maxVisitors'][2]). '>' . $this->forumkeyVal['maxVisitors'][0]. '</a>' ?></td>
